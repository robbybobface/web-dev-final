    ...
    return (
        <div className="contentMain">
            ...
            <ul>
                ...
                <li><a href="#2-your-personal-data-rights-and-controls">Your personal data rights
                                                                        and controls</a></li>
                <li><a href="#3-personal-data-we-collect-about-you">Personal data we collect about
                                                                    you</a></li>
                <li><a href="#4-our-usage-of-your-personal-data">Our usage of your personal data</a>
                </li>
            ...
            <p>From now on, we'll collectively call these the "<strong>Spotify Clone
                                                                       Service</strong>".</p>
            <p>From time to time, we may develop new or offer additional services. They'll also be
               subject to this Policy, unless stated otherwise when we introduce them.</p>
            <p><strong>This Policy is <em>not...</em></strong></p>
            <ul>
                <li>the Spotify Clone Terms of Use. That's a separate document, outlining the legal
                    contract between you and Spotify Clone for using the Spotify Service. It also
                    describes the rules of Spotify Clone and your user rights.
                </li>
                <li>about your use of other Spotify Clone services which have their own dedicated
                    privacy policy.
                </li>
            </ul>
            <br/>
            ...
            <h2>
                <a href={"#2-your-personal-data-rights-and-controls"}
                   id={"2-your-personal-data-rights-and-controls"}>
                    2. Your personal data rights and controls
                </a>
            </h2>
            <p>Privacy laws, including the General Data Protection Regulation ("GDPR"), give rights
               to individuals over their personal data.</p>
            ...
            <table>
                ...
                <tr>
                    <td>Access</td>
                    <td>Be informed of the personal data we process about you and to request access
                        to it
                    </td>
                </tr>
                <tr>
                    <td>Rectification</td>
                    <td>Request that we amend or update your personal data where it’s inaccurate or
                        incomplete
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>Restriction</td>
                    <td>Request that we temporarily or permanently stop processing all or some of
                        your personal data
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>Request a copy of your personal data in electronic format and the right
                        to transmit that personal data for use in another party’s service
                    </td>
                </tr>
                <tr>
            ...
            <h2>
                <a href={"#3-personal-data-we-collect-about-you"}
                   id={"3-personal-data-we-collect-about-you"}>
            ...
            <h2>
                <a href={"#4-our-usage-of-your-personal-data"}
                   id={"4-our-usage-of-your-personal-data"}>
